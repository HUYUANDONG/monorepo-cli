...
import { useSettingsStore, useAppStore } from "@web/store";
import { isExternal } from "@web/utils/index";
import path from "path-browserify";
import variables from "@web/styles/variables.module.scss";
import { LayoutEnum } from "@web/enums/LayoutEnum";
