...
export const useTable = (
  ...
  const getTableList = async () => {
    ...
    try {
      ...
      //   searchBefore && (state.totalParam = searchBefore(state.totalParam));
      //   searchBefore && (state.totalParam = searchBefore(state.totalParam));
      let searchMergeParam = {
        ...state.searchInitParam,
        ...state.totalParam,
      };
      searchBefore && (searchMergeParam = searchBefore(searchMergeParam));
      // console.log(state.totalParam,"totalParam---")
      let data = await api(searchMergeParam);
