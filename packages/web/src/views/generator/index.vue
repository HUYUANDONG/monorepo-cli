...
import { FormTypeEnum } from "@web/enums/FormTypeEnum";
import { QueryTypeEnum } from "@web/enums/QueryTypeEnum";
...
import GeneratorAPI, {
  ...
  TablePageQuery,
  FieldConfig,
} from "@web/api/generator";

import DictAPI from "@web/api/dict";
import MenuAPI from "@web/api/menu";
