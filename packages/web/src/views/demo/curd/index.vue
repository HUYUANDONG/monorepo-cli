...
import UserAPI from "@web/api/user";
import DeptAPI from "@web/api/dept";
import RoleAPI from "@web/api/role";
import type { IObject, IOperatData } from "@web/components/CURD/types";
import usePage from "@web/components/CURD/usePage";
